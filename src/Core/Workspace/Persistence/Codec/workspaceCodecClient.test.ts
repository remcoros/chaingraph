...
import { decryptWorkspaceOffThread, encryptWorkspaceOffThread } from './workspaceCodecClient';
import type { EncryptedEnvelope } from './encryptedEnvelope';
...
const workspace = createWorkspace('Worker fixture', 'mainnet');
class FakeWorker {
