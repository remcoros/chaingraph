...
import type { ScanResult, ScanObservation, ScanStopReason, ScanRun } from './connectionScans';
import { scanResultGroupKey } from './results';
import { scanResultEvidenceIds } from './records';
