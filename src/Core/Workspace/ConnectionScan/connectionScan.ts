import { scanEdgeKey, scanReconnectionKey } from './results';
import { SCAN_STATUS_ONLY_REASONS } from './connectionScanClassification';
...
import type {
  ...
  ScanSettings,
  ScanStopReason,
} from './connectionScans';
import { prepareScanContext, type ScanContextIndex } from './connectionScanContext';
