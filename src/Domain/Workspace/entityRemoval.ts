import { canonicalAddress, canonicalEntityNodeId } from '../Metadata/entityReferences';
import { graphRemovalClosure } from '../Graph/graphBranch';
import { outputNodeId, short, txNodeId, type Workspace } from '../types';
import { buildGraph, outputAddress } from './workspace';
import { buildWalletMatches } from '../Metadata/tags';
