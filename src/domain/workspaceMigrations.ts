...
export const CURRENT_WORKSPACE_VERSION = 1 as const;
 ...
 * Only an absent version identifies the legacy schema. Future schema changes add
 * explicit steps here; every result must still pass parseWorkspace validation.
