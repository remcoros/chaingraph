import { WorkspaceCryptoError } from './encryptedEnvelope';
import { WorkspaceSchemaVersionError } from '../Format/workspaceMigrations';
...
export function operationError(code: unknown): WorkspaceOperationError {
