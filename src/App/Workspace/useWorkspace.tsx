...
import { type AnalysisWorkbenchViewSession } from './Workbenches/Analysis/AnalysisWorkbench';
...
export function useWorkspace(app: ReturnType<typeof useAppState>) {
  ...
  const analysisSessions = useRef(new Map<string, AnalysisWorkbenchViewSession>());
