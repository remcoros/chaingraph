...
export function useWorkspace(app: ReturnType<typeof useAppState>) {
  ...
  const graphAddress = {
    ...
    outputIds: addressNavigation.addressOutputIds,
    lastTransactionTargets: addressNavigation.lastAddressTransactionTargets,
    actions: {
      ...
      showOutputs: addressNavigation.showAddressOutputs,
      showLastTransactions: addressNavigation.showLastAddressTransactions,
