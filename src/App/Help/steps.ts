...
export const WORKBENCH_TOUR: readonly TourStep[] = [
  {
    id: 'workspaces',
    label: 'Workspaces',
    title: 'Your investigation lives in one workspace',
    icon: FolderOpen,
    target: '[data-tour="workspace-tabs"]',
    text: 'A workspace keeps your wallets, transactions and annotations together, one Bitcoin network per workspace. Open several at once using the tabs above.',
    tip: 'Not ready to add your own wallet yet? Choose Example workspaces from Help to start with real transactions and annotations you can edit freely.',
  },
  {
    id: 'wallets',
    label: 'Wallets',
  ...
  },
  {
    ...
    tip: 'Tags and wallet matches can both highlight the graph. Sharing a tag records a grouping you made. It is not proof of common ownership.',
  },
  {
    id: 'entities',
    ...
    tip: 'Hide keeps the data in your workspace, just out of view. Use the Hidden filter to bring it back anytime. Removing an annotated entity asks you to confirm first. Graph and flow amount filters work independently of each other.',
  },
  {
    id: 'bookmarks',
    label: 'Bookmarks',
    ...
    text: 'Bookmark important transactions and outputs from the Inspector. This list gets you back to a useful point fast, with no more hunting for a transaction ID.',
