...
The separate CoinJoin laboratory comes from `src/domain/demo.ts`; it exercises graph rendering and reversible analysis using three synthetic 150-input / 150-output transactions.
